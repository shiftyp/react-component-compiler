...
import {
  ...
  getReactImport,
  checkForClientHooks,
  checkForClientComponents,
} from "react-component-compiler";
...
const clientTest = test as TestFn<{
  project: Project;
  react: ImportDeclaration;
}>;
...
clientTest.serial("find components", (t) => {
  const client = t.context.project.getSourceFile(fromFixtures("js/index.jsx"));
...
clientTest.serial("should find client component with hook", (t) => {
  ...
  const imports = checkForClientHooks(react!);
  const components = findComponents(client!);
  const foundClientComponents = checkForClientComponents(
    components[0],
    imports!
  );
...
clientTest.serial(
  "should find client component with global DOM reference",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
    const react = getReactImport(client!);
    const imports = checkForClientHooks(react!);
    const components = findComponents(client!);
...
clientTest.serial(
  "should find client component with aliased global DOM reference",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with custom client hook",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with aliased global DOM utility call",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with aliased window utility call",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with custom client hook property",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with aliased global DOM utility property call",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
...
clientTest.serial(
  "should find client component with aliased window utility property call",
  (t) => {
    const client = t.context.project.getSourceFile(
      fromFixtures("js/index.jsx")
    );
